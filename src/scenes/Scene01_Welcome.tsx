...
export const Scene01_Welcome: React.FC<{ durationInFrames: number }> = ({ durationInFrames }) => {
    ...
    const dateShineOpacity =
        dateShimmerProgress >= 0 ? interpolate(dateShimmerProgress, [0, 0.2, 0.8, 1], [0, 1, 1, 0]) : 0;
