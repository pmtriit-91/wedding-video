...
export const Scene03_BrideIntro: React.FC<{ durationInFrames: number }> = ({ durationInFrames }) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <ArchFrameShimmer width={920} height={1220} triggerFrames={[48, 220]} sweepDuration={65} />
            </div>
