...
export const weddingConfig: WeddingConfig = {
  ...
  scenes: {
    ...
    scene02_saveTheDate: {
      ...
      photos: [
        "photos/2/DSC_0609.jpg",
        "photos/2/DSC_0638.jpg",
        "photos/2/MAY_0981.jpg",
      ],
    },
    ...
    scene05_parentGratitude: {
      ...
      message: "Chúng con cảm ơn Bố Mẹ hai bên đã chấp thuận và vun đắp.",
      vowBookPhoto: "photos/4/DSC_0605.jpg",
      outdoorPhotos: [
        "photos/4/MAY_0534.jpg",
        "photos/4/MAY_0559.jpg",
      ],
    },

    // SCENE 6: Kỷ niệm tìm hiểu
    scene06_datingMemories: {
      quote: "Bọn con đã có quãng thời gian tìm hiểu và được sự đón nhận của Bố Mẹ hai bên.",
      photos: [
        "photos/5/1.JPG",
        "photos/5/2.JPG",
        "photos/5/3.JPG",
    ...
    scene10_wishesAndFallInLove: {
      wishesQuote: "Lời chúc phúc của mọi người là niềm tin để chúng con bước tiếp trên con đường phía trước của cả hai.",
      distanceThankQuote: "Chúng con xin cảm ơn tất cả mọi người đã sắp xếp công việc và thời gian không ngại vượt xa xôi để tới đây.",
      ...
      fallInLovePhotos: [
        "photos/8/Untitled Session36318.jpg",
        "photos/8/Untitled Session36491.jpg",
      ],
    },
    ...
    scene11_foreverHappy: {
      ...
      photos: [
        "photos/11/DSC_0120.jpg",
        "photos/11/DSC_0553.jpg",
        "photos/11/DSC_1167.jpg",
      ],
    },
